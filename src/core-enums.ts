...
import { BorderProps, OptsChartGridLine } from "./core-interfaces.ts";
...
export const DEF_CELL_BORDER: BorderProps = {
  type: "solid",
  color: "666666",
  pt: 1,
};
export const DEF_CELL_MARGIN_PT: [number, number, number, number] = [
  3,
  3,
  3,
  3,
]; // TRBL-style // DEPRECATED 3.8.0
...
export const DEF_CHART_BORDER: BorderProps = {
  type: "solid",
  color: "363636",
  pt: 1,
};
