...
import { CHART_NAME, DEF_FONT_COLOR, SHAPE_NAME } from "./core-enums.ts";
import {
  AddSlideProps,
  BackgroundProps,
  HexColor,
...
import { normalizeSlideTransition } from "./gen-transition.ts";
...
export default class Slide {
   ...
   * @type {HexColor}
   */
  private _color: HexColor = DEF_FONT_COLOR;
