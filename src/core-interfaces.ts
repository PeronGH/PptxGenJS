...
export type SlideTransitionCornerDirection =
  | "leftUp"
  | "rightUp"
  | "leftDown"
  | "rightDown";
export type SlideTransitionEightDirection =
...
export interface SlideTransitionOrientationProps
  extends SlideTransitionBaseProps {
  orientation?: SlideTransitionOrientation;
  type: "blinds" | "checker" | "comb" | "randomBar";
}
export interface SlideTransitionEightDirectionProps
  extends SlideTransitionBaseProps {
  direction?: SlideTransitionEightDirection;
  type: "cover" | "pull";
}
export interface SlideTransitionOptionalBlackProps
  extends SlideTransitionBaseProps {
  throughBlack?: boolean;
  type: "cut" | "fade";
}
export interface SlideTransitionSideDirectionProps
  extends SlideTransitionBaseProps {
